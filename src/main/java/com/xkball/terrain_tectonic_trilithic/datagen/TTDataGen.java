...
import com.xkball.terrain_tectonic_trilithic.datagen.recipe.TTRecipeProvider;
...
public class TTDataGen {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        dataGenerator.addProvider(runClient, new TTRecipeProvider(packOutput, registries));
