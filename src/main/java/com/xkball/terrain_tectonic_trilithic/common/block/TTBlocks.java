...
//            .setCreativeTab(TTRegistries.BLOCK_TAB);
    ...
    public static final RegBlock<StateRequireRenewableOre> PHYLLORE = new RegBlock<>("phyllore", () -> new StateRequireRenewableOre(BlockBehaviour.Properties.of().sound(SoundType.MOSS).strength(3.0f, 3.0f).requiresCorrectToolForDrops().mapColor(MapColor.COLOR_GREEN),
    ...
    public static final RegBlock<StateRequireRenewableOre> GLACIED_ORE = new RegBlock<>("glacied_ore", () -> new StateRequireRenewableOre(BlockBehaviour.Properties.of().sound(SoundType.GLASS).strength(3.0f, 3.0f).requiresCorrectToolForDrops().mapColor(MapColor.ICE),
    ...
    public static final RegBlock<StateRequireRenewableOre> BLAZE_ORE = new RegBlock<>("blaze_ore", () -> new StateRequireRenewableOre(BlockBehaviour.Properties.of().sound(SoundType.NETHERRACK).strength(3.0f, 3.0f).requiresCorrectToolForDrops().mapColor(MapColor.ICE),
