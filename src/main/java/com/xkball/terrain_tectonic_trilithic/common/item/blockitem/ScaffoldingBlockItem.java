package com.xkball.terrain_tectonic_trilithic.common.item.blockitem;

import com.xkball.terrain_tectonic_trilithic.common.block.ScaffoldingBlock;
...
public class ScaffoldingBlockItem extends BlockItem {
    ...
    public ScaffoldingBlockItem() {
        super(TTBlocks.SCAFFOLDING_BLOCK.get(), new Properties());
    }
    
    @Override
    @SuppressWarnings("deprecation")
    protected SoundEvent getPlaceSound(BlockState p_state, Level world, BlockPos pos, Player entity) {
        return TTBlocks.SCAFFOLDING_BLOCK.get().defaultBlockState().getSoundType().getPlaceSound();
    }
